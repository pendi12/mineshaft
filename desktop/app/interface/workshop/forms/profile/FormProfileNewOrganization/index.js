...
/* --------------------------- Component Entry ------------------------------ */
const FormProfileNewOrganization = props => <FormRender { ...props} />
...
export const config = {
  form: 'FormProfileNewOrganization',
  fields: [
    'nameOrganization',
    'communicationEmail',
    'communicationPhone',
...
export default connect(mapStateToProps, mapDispatchToProps)(reduxForm(config)(FormProfileNewOrganization))
