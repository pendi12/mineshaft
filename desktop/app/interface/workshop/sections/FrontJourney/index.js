  ...
  <Section of='hidden' >
    <Flex justify={['space-evenly']}>
      <Box w={[1,1, 0.25]}  pos="relative" gradient="blueAlge">
        <BackgroundImage image={assets.images.marchDream} o={[0.8]}/>
      </Box>
      ...
      <Box w={[1,1, 0.25]}  pos="relative"  gradient="ibize">
        <BackgroundImage image={assets.bg.justice} o={[0.8]} />
      </Box>
    ...
    <Flex justify={['space-evenly']}>
      ...
      <Box w={[1,1, 0.25]}  pos="relative" gradient="cherry" >
        <BackgroundImage image={assets.images.immigrantMarch} ratio={1} o={[0.8]} />
      </Box>
      ...
      <Box w={[1,1, 0.25]} pos="relative" gradient="purple">
        <BackgroundImage image={assets.images.communityOrganizing} ratio={1/3}  o={[0.8]}/>
      </Box>
    </Flex>
  </Section>
   )
