...
<div>
<Section bg={['orange']} gradient='greenDeep' color={['white']} py={[20,40,220]} z={10} pos='relative'  >
  <Container w={[1,1, 720]} px={[20, 10, 0]} >
    <Heading f={[6,7]} level={[5]}>Merging Knowledge + Trusted Experience</Heading>
...
<Section color={['charcoal']} z={15} pos='relative' >
  ...
  <Flex align={['left']} justify={['center']} direction={['column']}  bg={['blueDark']} color={['white']} h={[450]} px={[15,20,50]} w={[1]} pos='relative' bs={[0,1]}>
    <BackgroundImage image={assets.images.communityOrganizing} z={1} o={[1]} ratio={1/2} />
  </Flex>
</Container>
...
<Section bg="white" >
  <Container w={[720]} py={[20,40]} >
    <Heading f={[6,7]} color="green" level={[5]}>Sowing Seeds Of Change</Heading>
