...
export default class MenuBuilder {
  ...
  buildDarwinTemplate() {
    const subMenuAbout = {
      label: 'Mineshaft',
      submenu: [
        { label: 'About Mineshaft', selector: 'orderFrontStandardAboutPanel:' },
        { type: 'separator' },
  ...
  buildDefaultTemplate() {
    const templateDefault = [{
      ...
      submenu: [{
        label: 'Learn More',
        click() {
          shell.openExternal('https://github.com/KamesCG/mineshaft');
        }
      }, {
        label: 'Documentation',
        click() {
          shell.openExternal('https://github.com/KamesCG/mineshaft#readme');
        }
      }, {
